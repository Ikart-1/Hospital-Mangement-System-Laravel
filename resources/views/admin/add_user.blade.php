    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 style="color: #06A3DA;"  class="font-weight-bolder mb-0">Ajouter Patient</h6>
        </nav>
            ...
            <div class="col-12">
              <div class="card mb-4">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Ajouter Patient</h3>
                  <p class="mb-0">Saisir les informations personnelles du Patient.</p>
                </div>
                <div class="card-body">
